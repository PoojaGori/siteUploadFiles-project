...
def add_qsForTest(): return "process_department=lighting&process_ent_id=123&user=Pooja&project=Donald&asset=Boat&version=0.0.1"
...
def submit_form(request):
    ...
    if request.method == 'GET':
        ...
        # request.upload_handlers.insert(0, MyProjectUploadHandler())
...
def submit_form_post(request):
    ...
    # print (" REQUEST File Path : {}".format(objfile._file_path))
    ...
    if submitted_form.is_valid():
        ...
        submitted_form.file_path = objfile._file_path
